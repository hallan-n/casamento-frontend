export default function Gift({ thumb, name, description, price, isReserved, id }) {
    ...
    return (
        <div className='bg-zinc-200 w-80 h-96 rounded-md overflow-hidden flex flex-col p-2'>
            ...
            <div className='p-3 flex flex-col justify-between flex-grow'>
                <div>
                    <p className='font-bold text-sm w-full overflow-hidden text-ellipsis break-words [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]'>{name}</p>
                    <p className="text-sm w-full overflow-hidden text-ellipsis break-words [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">
                        {description}
                    </p>
                </div>
